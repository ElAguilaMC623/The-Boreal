...
public class BorealSwordItem extends SwordItem {

    private final boolean unbreakable;

    public BorealSwordItem(Tier tier, int attackDamage, float attackSpeed, Properties properties) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> tooltip, TooltipFlag flag) {
        tooltip.add(Component.translatable("tooltip.the_boreal.diorium_sword").withStyle(ChatFormatting.AQUA));
    }
}
