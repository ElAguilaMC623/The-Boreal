...
public class BorealBoatItem extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);
    private final BorealBoatEntity.Type type;
    private final boolean hasChest;

    public BorealBoatItem(boolean pHasChest, BorealBoatEntity.Type pType, Item.Properties pProperties) {
        super(pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level pLevel, Player pPlayer, InteractionHand pHand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ...
                if(boat instanceof BorealChestBoatEntity chestBoat) {
                    chestBoat.setVariant(this.type);
                } else if(boat instanceof BorealBoatEntity) {
                    ((BorealBoatEntity)boat).setVariant(this.type);
                }
