...
public class NightDeerRenderer extends MobRenderer<NightDeerEntity, NightDeerModel<NightDeerEntity>> {
    ...
    @Override
    public ResourceLocation getTextureLocation(NightDeerEntity pEntity) {
        return new ResourceLocation(TheBoreal.MOD_ID, "textures/entity/night_deer.png");
    }

    @Override
    public void render(NightDeerEntity pEntity, float pEntityYaw, float pPartialTicks, PoseStack pMatrixStack,
