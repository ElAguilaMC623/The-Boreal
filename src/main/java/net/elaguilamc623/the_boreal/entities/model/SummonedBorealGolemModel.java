...
public class SummonedBorealGolemModel extends HierarchicalModel<SummonedBorealGolem> {
    ...
    public SummonedBorealGolemModel(ModelPart root) {
    ...
    @Override
    public void setupAnim(SummonedBorealGolem entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public void prepareMobModel(SummonedBorealGolem entity, float limbSwing, float limbSwingAmount, float partialTicks) {
